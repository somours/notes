 ...
 * @version: 1.0
 * @Author: somours
 * @Date: 2020-12-31 00:37:19
 * @LastEditors: somours
 * @LastEditTime: 2021-01-20 17:55:08
-->
<template>
  <div class="sizer-rate">
    <div ref="bar" class="bar">
      <div class="mask" :style="state.style"></div>
      <div ref="barBtn1" class="bar-btn"></div>
      <div ref="barBtn2" class="bar-btn"></div>
    </div>
    <div class="bottom">
